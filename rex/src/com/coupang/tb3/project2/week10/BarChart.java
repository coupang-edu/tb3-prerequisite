...
/**
 * The {@code BarChart} class represents a library for drawing static bar chart. It supports adding a bar (with a
 * specified name, value, and category) and drawing all of the bars to the screen using standard draw. The bars are
 * drawn horizontally (in the order in which they are added from top to bottom) and colored according to the category.
...
public class BarChart {
    ...
    /**
     * Sets the maximum x-value of this bar chart (instead of having it set automatially). This method is useful if you
     * know that the values stay within a given range.
     *
    ...
    /**
     * Sets the caption of this bar chart. The caption is drawn in the lower-right part of the window.
     *
    ...
    /**
     * Adds a bar to the bar chart. The length of a bar is proportional to its value. The bars are drawn from top to
     * bottom in the order they are added. All bars from the same category are drawn with the same color.
     *
    ...
    /**
     * Removes all of the bars from this bar chart (but keep the color scheme). This method is convenient when drawing
